...
//   01 Apr 01  Modified to use new "third_party/boost/boost/limits.hpp" header. (John Maddock)
...
#include "third_party/boost/boost/integer_fwd.hpp"  // self include

#include "third_party/boost/boost/integer_traits.hpp"  // for boost::::boost::integer_traits
#include "third_party/boost/boost/limits.hpp"          // for ::std::numeric_limits
#include "third_party/boost/boost/cstdint.hpp"         // for boost::int64_t and BOOST_NO_INTEGRAL_INT64_T
