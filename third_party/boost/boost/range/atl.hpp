...
#include <atldef.h> // _ATL_VER
    ...
    #if (_MSC_VER < 1310)   // from "third_party/boost/boost/regex/mfc.hpp", but dubious
...
#include "third_party/boost/boost/iterator/indirect_iterator.hpp"
#include "third_party/boost/boost/iterator/zip_iterator.hpp"
#include "third_party/boost/boost/range/detail/microsoft.hpp"
