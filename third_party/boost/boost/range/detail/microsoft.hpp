...
#include "third_party/boost/boost/iterator/iterator_traits.hpp" // iterator_difference
...
#include "third_party/boost/boost/preprocessor/detail/is_unary.hpp"
#include "third_party/boost/boost/preprocessor/list/for_each.hpp"
...
#include "third_party/boost/boost/utility/enable_if.hpp" // disable_if

#if !defined(BOOST_RANGE_DETAIL_MICROSOFT_RANGE_VERSION_1)
    #include "third_party/boost/boost/range/mutable_iterator.hpp"
#else
...
#include "third_party/boost/boost/range/distance.hpp"
#include "third_party/boost/boost/range/empty.hpp"
#include "third_party/boost/boost/range/iterator_range.hpp"
#include "third_party/boost/boost/range/mutable_iterator.hpp"
#include "third_party/boost/boost/range/rbegin.hpp"
#include "third_party/boost/boost/range/rend.hpp"
