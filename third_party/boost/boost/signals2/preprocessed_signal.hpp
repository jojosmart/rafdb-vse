...
#include "third_party/boost/boost/preprocessor/arithmetic.hpp"
#include "third_party/boost/boost/preprocessor/cat.hpp"
#include "third_party/boost/boost/preprocessor/control/expr_if.hpp"
#include "third_party/boost/boost/preprocessor/iteration.hpp"
#include "third_party/boost/boost/preprocessor/repetition.hpp"
#include "third_party/boost/boost/signals2/detail/preprocessed_arg_type.hpp"
#include "third_party/boost/boost/type_traits/add_reference.hpp"

#define BOOST_PP_ITERATION_LIMITS (0, BOOST_SIGNALS2_MAX_ARGS)
#define BOOST_PP_FILENAME_1 "third_party/boost/boost/signals2/detail/signal_template.hpp"
