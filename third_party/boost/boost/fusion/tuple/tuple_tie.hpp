...
#include "third_party/boost/boost/fusion/tuple/detail/preprocessed/tuple_tie.hpp"
#else
...
#define BOOST_PP_FILENAME_1 "third_party/boost/boost/fusion/tuple/tuple_tie.hpp"
