...
#include "third_party/boost/boost/fusion/container/set/detail/preprocessed/as_set.hpp"
#else
...
#define BOOST_PP_FILENAME_1 "third_party/boost/boost/fusion/container/set/detail/as_set.hpp"
