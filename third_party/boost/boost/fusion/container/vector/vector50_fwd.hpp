...
#include "third_party/boost/boost/fusion/container/vector/detail/preprocessed/vector50_fwd.hpp"
#else
...
namespace boost { namespace fusion
{
    ...
    #define BOOST_PP_FILENAME_1 "third_party/boost/boost/fusion/container/vector/vector50_fwd.hpp"
