...
#include "third_party/boost/boost/fusion/container/vector/detail/preprocessed/vector40_fwd.hpp"
#else
...
namespace boost { namespace fusion
{
    ...
    #define BOOST_PP_FILENAME_1 "third_party/boost/boost/fusion/container/vector/vector40_fwd.hpp"
