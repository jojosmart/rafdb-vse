...
#include "third_party/boost/boost/fusion/container/vector/detail/preprocessed/vector20_fwd.hpp"
#else
...
namespace boost { namespace fusion
{
    ...
    #define BOOST_PP_FILENAME_1 "third_party/boost/boost/fusion/container/vector/vector20_fwd.hpp"
