...
#include "third_party/boost/boost/fusion/container/list/detail/preprocessed/list_to_cons.hpp"
#else
...
namespace boost { namespace fusion { namespace detail
{
    ...
    struct list_to_cons
    {
        ...
        #include "third_party/boost/boost/fusion/container/list/detail/list_to_cons_call.hpp"
    };
