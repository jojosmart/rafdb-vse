...
#include "third_party/boost/boost/cstdint.hpp" // for boost::uintmax_t
...
#include "third_party/boost/boost/math/tools/user.hpp"
...
void suppress_unused_variable_warning(const T&)
{
   ...
   #include "third_party/boost/boost/detail/fenv.hpp"
