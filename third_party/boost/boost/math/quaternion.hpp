...
#include "third_party/boost/boost/config.hpp" // for BOOST_NO_STD_LOCALE
...
#include "third_party/boost/boost/math/special_functions/sinc.hpp"    // for the Sinus cardinal
#include "third_party/boost/boost/math/special_functions/sinhc.hpp"    // for the Hyperbolic Sinus cardinal
