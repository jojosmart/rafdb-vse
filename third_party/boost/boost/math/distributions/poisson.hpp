...
#include "third_party/boost/boost/math/special_functions/trunc.hpp" // for incomplete gamma. gamma_q
...
#include "third_party/boost/boost/math/special_functions/factorials.hpp" // factorials.
#include "third_party/boost/boost/math/tools/roots.hpp" // for root finding.
#include "third_party/boost/boost/math/distributions/detail/inv_discrete_quantile.hpp"
