...
#include "third_party/boost/boost/math/special_functions/beta.hpp" // for incomplete beta.
...
#include "third_party/boost/boost/math/distributions/detail/inv_discrete_quantile.hpp" // error checks
