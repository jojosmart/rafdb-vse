...
#include "third_party/boost/boost/config.hpp"       // SFINAE, MSVC, put ptrdiff_t in std.
#include <algorithm>              // copy, min.
#include <cstddef>                // ptrdiff_t.
#include "third_party/boost/boost/detail/workaround.hpp"
#include "third_party/boost/boost/iostreams/categories.hpp"
#include "third_party/boost/boost/iostreams/detail/config/limits.hpp"        // forwarding.
#include "third_party/boost/boost/iostreams/detail/config/wide_streams.hpp"  // locale.
...
#include "third_party/boost/boost/iostreams/detail/ios.hpp"  // openmode, seekdir, int types.
...
// Must come last.
#include "third_party/boost/boost/iostreams/detail/config/disable_warnings.hpp" // VC7.1
