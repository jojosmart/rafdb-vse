...
#include "third_party/boost/boost/config.hpp"                        // BOOST_DEDUCED_TYPENAME, 
#include "third_party/boost/boost/iostreams/detail/char_traits.hpp"  // member template friends.
...
#include "third_party/boost/boost/iostreams/detail/streambuf.hpp"
...
// Must come last.
#include "third_party/boost/boost/iostreams/detail/config/disable_warnings.hpp" // MSVC.
...
#include "third_party/boost/boost/iostreams/detail/config/enable_warnings.hpp" // MSVC
