...
#include "third_party/boost/boost/config.hpp"                 // Make sure ptrdiff_t is in std.
#include <algorithm>                        // copy, min.
#include <cstddef>                          // ptrdiff_t.
#include <utility>                          // pair.
#include "third_party/boost/boost/bind.hpp"
#include "third_party/boost/boost/detail/workaround.hpp"
#include "third_party/boost/boost/iostreams/chain.hpp"
#include "third_party/boost/boost/iostreams/constants.hpp"
#include "third_party/boost/boost/iostreams/detail/adapter/non_blocking_adapter.hpp"        
...
#include "third_party/boost/boost/iostreams/detail/ios.hpp"   // failure, streamsize.                   
#include "third_party/boost/boost/iostreams/detail/resolve.hpp"                   
#include "third_party/boost/boost/iostreams/detail/wrap_unwrap.hpp"
#include "third_party/boost/boost/iostreams/operations.hpp"  // read, write, close.
#include "third_party/boost/boost/iostreams/pipeline.hpp"
