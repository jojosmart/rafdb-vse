...
#include "third_party/boost/boost/config.hpp" // STATIC_CONSTANT, STDC_NAMESPACE, 
...
#include "third_party/boost/boost/config.hpp"               // Put size_t in std.
#include "third_party/boost/boost/detail/workaround.hpp"
#include "third_party/boost/boost/cstdint.hpp"              // uint8_t, uint32_t.
#include "third_party/boost/boost/iostreams/constants.hpp"  // buffer size.
...
#include "third_party/boost/boost/iostreams/device/back_inserter.hpp"
#include "third_party/boost/boost/iostreams/filter/zlib.hpp"
#include "third_party/boost/boost/iostreams/pipeline.hpp"     
#include "third_party/boost/boost/iostreams/putback.hpp"
