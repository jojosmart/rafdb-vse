...
#include "third_party/boost/boost/iostreams/checked_operations.hpp"
...
// Must come last.
#include "third_party/boost/boost/iostreams/detail/config/disable_warnings.hpp" // VC7.1 C4244.
