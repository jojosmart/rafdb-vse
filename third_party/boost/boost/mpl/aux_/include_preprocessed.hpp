...
#include "third_party/boost/boost/mpl/aux_/config/compiler.hpp"
...
#else
#   include BOOST_PP_STRINGIZE(third_party/boost/boost/mpl/aux_/preprocessed/AUX778076_PREPROCESSED_HEADER)
#endif
