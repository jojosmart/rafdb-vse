...
#include "third_party/boost/boost/assert.hpp"
   ...
   #include "third_party/boost/boost/interprocess/sync/posix/recursive_mutex.hpp"
   #define BOOST_INTERPROCESS_USE_POSIX
//Experimental...
//#elif !defined(BOOST_INTERPROCESS_FORCE_GENERIC_EMULATION) && defined (BOOST_INTERPROCESS_WINDOWS)
//   #include "third_party/boost/boost/interprocess/sync/windows/recursive_mutex.hpp"
//   #define BOOST_INTERPROCESS_USE_WINDOWS
#elif !defined(BOOST_INTERPROCESS_DOXYGEN_INVOKED)
   #include "third_party/boost/boost/interprocess/sync/spin/recursive_mutex.hpp"
