...
#include "third_party/boost/boost/interprocess/containers/list.hpp"//list
#include "third_party/boost/boost/interprocess/mapped_region.hpp" //mapped_region
#include "third_party/boost/boost/interprocess/shared_memory_object.hpp"
#include "third_party/boost/boost/interprocess/permissions.hpp"
#include "third_party/boost/boost/interprocess/detail/managed_open_or_create_impl.hpp" //managed_open_or_create_impl
#include <new>
#include "third_party/boost/boost/interprocess/containers/string.hpp"
#include "third_party/boost/boost/interprocess/streams/vectorstream.hpp"
#include <memory>
