...
#include "third_party/boost/boost/interprocess/detail/utilities.hpp" //to_raw_pointer
#include "third_party/boost/boost/utility/addressof.hpp" //boost::addressof
#include "third_party/boost/boost/assert.hpp"   //BOOST_ASSERT
#include "third_party/boost/boost/interprocess/exceptions.hpp" //bad_alloc
#include "third_party/boost/boost/interprocess/sync/scoped_lock.hpp" //scoped_lock
#include "third_party/boost/boost/interprocess/containers/allocation_type.hpp" //boost::interprocess::allocation_type
#include "third_party/boost/boost/container/detail/multiallocation_chain.hpp"
#include "third_party/boost/boost/interprocess/mem_algo/detail/mem_algo_common.hpp"
#include "third_party/boost/boost/interprocess/detail/segment_manager_helper.hpp"
