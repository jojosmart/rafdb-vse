...
#include "third_party/boost/boost/preprocessor/iteration/self.hpp"
...
#   define BOOST_PP_INDIRECT_SELF "third_party/boost/boost/typeof/vector.hpp"
#   if   BOOST_TYPEOF_LIMIT_SIZE < 50
#     include BOOST_PP_INCLUDE_SELF()
#   elif BOOST_TYPEOF_LIMIT_SIZE < 100
#     include "third_party/boost/boost/typeof/vector50.hpp"
#     define  BOOST_TYPEOF_PP_START_SIZE 51
#     include BOOST_PP_INCLUDE_SELF()
#   elif BOOST_TYPEOF_LIMIT_SIZE < 150
#     include "third_party/boost/boost/typeof/vector100.hpp"
#     define  BOOST_TYPEOF_PP_START_SIZE 101
#     include BOOST_PP_INCLUDE_SELF()
#   elif BOOST_TYPEOF_LIMIT_SIZE < 200
#     include "third_party/boost/boost/typeof/vector150.hpp"
#     define  BOOST_TYPEOF_PP_START_SIZE 151
#     include BOOST_PP_INCLUDE_SELF()
#   elif BOOST_TYPEOF_LIMIT_SIZE <= 250
#     include "third_party/boost/boost/typeof/vector200.hpp"
...
#     include "third_party/boost/boost/preprocessor/repeat_from_to.hpp"
