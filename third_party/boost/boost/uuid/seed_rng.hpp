...
#include "third_party/boost/boost/uuid/sha1.hpp"
//#include "third_party/boost/boost/nondet_random.hpp" //forward declare boost::random::random_device

// can't use boost::generator_iterator since boost::random number seed(Iter&, Iter)
// functions need a last iterator
//#include "third_party/boost/boost/generator_iterator.hpp"
