...
#include "third_party/boost/boost/regex/config.hpp" // dll import/export options.
...
//
#define B1 "third_party/boost/boost/thread/once.hpp"
#define B2 "third_party/boost/boost/thread/recursive_mutex.hpp"
#include B1
#include B2
#undef B1
#undef B2
