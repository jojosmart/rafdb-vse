...
#include "third_party/boost/boost/phoenix/bind/detail/function_ptr.hpp"
...
namespace boost { namespace phoenix {
    ...
    #include "third_party/boost/boost/phoenix/bind/preprocessed/bind_function.hpp"
#else
...
#define BOOST_PHOENIX_ITERATION_PARAMS                                          \
    (3, (2, BOOST_PP_DEC(BOOST_PHOENIX_ACTOR_LIMIT),                            \
            "third_party/boost/boost/phoenix/bind/bind_function.hpp"))
