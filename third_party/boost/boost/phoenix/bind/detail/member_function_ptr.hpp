...
namespace boost { namespace phoenix { namespace detail
{
    ...
    #include "third_party/boost/boost/phoenix/bind/detail/preprocessed/member_function_ptr.hpp"
#else
...
#define BOOST_PHOENIX_ITERATION_PARAMS                                          \
    ...
    "third_party/boost/boost/phoenix/bind/detail/member_function_ptr.hpp"))
