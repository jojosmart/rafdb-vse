...
#include "third_party/boost/boost/chrono/detail/inlined/win/thread_clock.hpp"

//----------------------------------------------------------------------------//
//                                 Mac                                        //
//----------------------------------------------------------------------------//
#elif defined(BOOST_CHRONO_MAC_API)
#include "third_party/boost/boost/chrono/detail/inlined/mac/thread_clock.hpp"

//----------------------------------------------------------------------------//
//                                POSIX                                     //
//----------------------------------------------------------------------------//
#elif defined(BOOST_CHRONO_POSIX_API)
#include "third_party/boost/boost/chrono/detail/inlined/posix/thread_clock.hpp"
