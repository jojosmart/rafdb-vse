    ...
    #include "third_party/boost/boost/proto/detail/preprocessed/funop.hpp"
    ...
    #define BOOST_PP_ITERATION_PARAMS_1                                                             \
        (3, (0, BOOST_PP_DEC(BOOST_PROTO_MAX_FUNCTION_CALL_ARITY), "third_party/boost/boost/proto/detail/funop.hpp"))
