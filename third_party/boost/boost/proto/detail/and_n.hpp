    ...
    #include "third_party/boost/boost/proto/detail/preprocessed/and_n.hpp"
    ...
    #define BOOST_PP_ITERATION_PARAMS_1                                                             \
        (3, (2, BOOST_PP_MAX(BOOST_PROTO_MAX_ARITY, BOOST_PROTO_MAX_LOGICAL_ARITY), "third_party/boost/boost/proto/detail/and_n.hpp"))
