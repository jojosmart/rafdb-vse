...
#include "third_party/boost/boost/proto/traits.hpp" // for proto::child_c()
#include "third_party/boost/boost/proto/detail/decltype.hpp"
...
#define UNREF(x) typename boost::remove_reference<x>::type
    ...
    #undef BOOST_PROTO_BINARY_DEFAULT_EVAL
        ...
        #include "third_party/boost/boost/proto/context/detail/default_eval.hpp"
