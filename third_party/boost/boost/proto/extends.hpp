...
#include "third_party/boost/boost/proto/expr.hpp"
#include "third_party/boost/boost/proto/args.hpp"
#include "third_party/boost/boost/proto/traits.hpp"
#include "third_party/boost/boost/proto/generate.hpp"
#include "third_party/boost/boost/proto/detail/remove_typename.hpp"
...
namespace boost { namespace proto
{
    ...
    namespace exprns_
    {
        ...
        struct extends
        {
            ...
            #include "third_party/boost/boost/proto/detail/extends_funop_const.hpp"
        };
        ...
        struct extends<Expr, Derived, Domain, 0>
        {
            ...
            // nested preprocessor loops, use file iteration here to generate
            // the operator() overloads, which is more efficient.
            #include "third_party/boost/boost/proto/detail/extends_funop.hpp"
        };
