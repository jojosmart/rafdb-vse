...
#include "third_party/boost/boost/proto/proto_fwd.hpp" // for BOOST_PROTO_MAX_ARITY
...
/// \li BOOST_PROTO_LOCAL_A_a
/// \li BOOST_PROTO_LOCAL_a
#define BOOST_PROTO_LOCAL_ITERATE() "third_party/boost/boost/proto/detail/local.hpp"
