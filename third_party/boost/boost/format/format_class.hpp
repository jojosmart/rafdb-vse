...
#include "third_party/boost/boost/optional.hpp" // to store locale when needed

#include "third_party/boost/boost/format/format_fwd.hpp"
#include "third_party/boost/boost/format/internals_fwd.hpp"
#include "third_party/boost/boost/format/internals.hpp"
#include "third_party/boost/boost/format/alt_sstream.hpp"
