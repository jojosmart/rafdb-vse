...
#include "third_party/boost/boost/mpl/vector/vector0.hpp"
...
#   include "third_party/boost/boost/mpl/vector/vector10.hpp"
#   include "third_party/boost/boost/mpl/front.hpp"
#   include "third_party/boost/boost/mpl/begin.hpp"
#   include "third_party/boost/boost/mpl/advance.hpp"
#   include "third_party/boost/boost/mpl/iterator_range.hpp"
#   include "third_party/boost/boost/mpl/joint_view.hpp"
#   include "third_party/boost/boost/mpl/equal_to.hpp"
#   include "third_party/boost/boost/mpl/copy.hpp"
#   include "third_party/boost/boost/mpl/front_inserter.hpp"

#   include "third_party/boost/boost/function_types/detail/classifier.hpp"
#endif

#ifndef BOOST_FT_NO_CV_FUNC_SUPPORT
#   include "third_party/boost/boost/mpl/remove.hpp"
#endif

#include "third_party/boost/boost/function_types/config/config.hpp"
...
#     include "third_party/boost/boost/mpl/vector/vector30.hpp"
#   elif BOOST_FT_MAX_ARITY < 40
#     include "third_party/boost/boost/mpl/vector/vector40.hpp"
#   elif BOOST_FT_MAX_ARITY < 50
#     include "third_party/boost/boost/mpl/vector/vector50.hpp"
#   endif
#else
#   include "third_party/boost/boost/function_types/detail/classifier.hpp"
#endif

#include "third_party/boost/boost/function_types/detail/class_transform.hpp"
#include "third_party/boost/boost/function_types/property_tags.hpp"
...
#include "third_party/boost/boost/function_types/detail/pp_loop.hpp"
...
#include "third_party/boost/boost/function_types/detail/components_as_mpl_sequence.hpp"
#include "third_party/boost/boost/function_types/detail/retag_default_cc.hpp"
