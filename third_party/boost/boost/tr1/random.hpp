...
#else
// Boost.Random:
#include "third_party/boost/boost/random.hpp"
#ifndef __SUNPRO_CC
    // Sunpros linker complains if we so much as include this...
#   include "third_party/boost/boost/nondet_random.hpp"
#endif
#include "third_party/boost/boost/tr1/detail/functor2iterator.hpp"
