...
#include "third_party/boost/boost/serialization/shared_ptr_132.hpp"
...
#include "third_party/boost/boost/archive/detail/abi_prefix.hpp" // must be the last headern
