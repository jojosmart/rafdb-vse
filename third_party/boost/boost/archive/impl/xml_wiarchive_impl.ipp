...
#include "third_party/boost/boost/config.hpp" // msvc 6.0 needs this to suppress warnings
#ifndef BOOST_NO_STD_WSTREAMBUF

#include "third_party/boost/boost/assert.hpp"
#include <algorithm>

#include "third_party/boost/boost/detail/workaround.hpp" // Dinkumware and RogueWave
...
#include "third_party/boost/boost/archive/add_facet.hpp"
#include "third_party/boost/boost/archive/xml_archive_exception.hpp"
#include "third_party/boost/boost/archive/detail/utf8_codecvt_facet.hpp"

#include "third_party/boost/boost/archive/iterators/mb_from_wchar.hpp"

#include "third_party/boost/boost/archive/basic_xml_archive.hpp"
#include "third_party/boost/boost/archive/xml_wiarchive.hpp"
