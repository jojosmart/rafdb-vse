...
# define BOOST_PP_ITERATION_PARAMS_1 (4, \
    (1, BOOST_PARAMETER_MAX_ARITY, "third_party/boost/boost/parameter/aux_/python/invoker_iterate.hpp", 1))
# include BOOST_PP_ITERATE()

# define BOOST_PP_ITERATION_PARAMS_1 (4, \
    (1, BOOST_PARAMETER_MAX_ARITY, "third_party/boost/boost/parameter/aux_/python/invoker_iterate.hpp", 2))
# include BOOST_PP_ITERATE()

# define BOOST_PP_ITERATION_PARAMS_1 (4, \
    (1, BOOST_PARAMETER_MAX_ARITY, "third_party/boost/boost/parameter/aux_/python/invoker_iterate.hpp", 3))
# include BOOST_PP_ITERATE()

# define BOOST_PP_ITERATION_PARAMS_1 (4, \
    (1, BOOST_PARAMETER_MAX_ARITY, "third_party/boost/boost/parameter/aux_/python/invoker_iterate.hpp", 4))
# include BOOST_PP_ITERATE()
