...
#include "third_party/boost/boost/config.hpp" // msvc 6.0 needs this for warning suppression
...
#include "third_party/boost/boost/serialization/detail/stack_constructor.hpp"
