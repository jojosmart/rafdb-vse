...
#include "third_party/boost/boost/config.hpp"   // for broken compiler workarounds

#if defined(BOOST_NO_MEMBER_TEMPLATES) && !defined(BOOST_MSVC6_MEMBER_TEMPLATES)
#include "third_party/boost/boost/smart_ptr/detail/shared_ptr_nmt.hpp"
#else
...
#include "third_party/boost/boost/smart_ptr/detail/shared_count.hpp"
#include "third_party/boost/boost/detail/workaround.hpp"
#include "third_party/boost/boost/smart_ptr/detail/sp_convertible.hpp"

#if !defined(BOOST_SP_NO_ATOMIC_ACCESS)
#include "third_party/boost/boost/smart_ptr/detail/spinlock_pool.hpp"
#include "third_party/boost/boost/memory_order.hpp"
#endif
