...
#  include "third_party/boost/boost/type_traits/object_traits.hpp"
...
#  define BOOST_PP_ITERATION_PARAMS_1                                                                   \
    (4, (0, BOOST_PYTHON_MAX_ARITY, "third_party/boost/boost/python/detail/result.hpp", BOOST_PYTHON_FUNCTION_POINTER))
#  include BOOST_PP_ITERATE()

#  define BOOST_PP_ITERATION_PARAMS_1                                                                     \
    (4, (0, BOOST_PYTHON_CV_COUNT - 1, "third_party/boost/boost/python/detail/result.hpp", BOOST_PYTHON_POINTER_TO_MEMBER))
#  include BOOST_PP_ITERATE()
...
# define BOOST_PP_ITERATION_PARAMS_2 (3, (0, BOOST_PYTHON_MAX_ARITY, "third_party/boost/boost/python/detail/result.hpp"))
# include BOOST_PP_ITERATE()
